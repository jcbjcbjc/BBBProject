...
public class _stage_control : MonoBehaviour
{
    ...
    private void Start()
    {
        MessageCenter.SendMessage(ProConst.UPDATE_CLASSIC_UI, new string[] { "", "1" });
        Multiple_Start_game();
    }
    ...
    public void _gameover(int winner)
    {
        ...
        _UI_Control.Instance.GetComponent<_UI_Control>().SetStartUI(false);

        UIManager.GetInstance().CloseUIForms(ProConst.CLASSIC_UIFORM);
    ...
    IEnumerator _success1()
    {
        ...
        while (elapsedTime < _Bet_time)
        {
            ...
            //----------------------------------------------
            _UI_Control.Instance.GetComponent<_UI_Control>()._UI_Little[0].SetActive(true);
            elapsedTime += Time.deltaTime;
            //----------------------------------------------
            yield return new WaitForEndOfFrame();

            _UI_Control.Instance.GetComponent<_UI_Control>()._UI_Little[0].SetActive(false);
        }
    }
    IEnumerator _fail1()
    {
        ...
        {
            //----------------------------------------------
            _UI_Control.Instance.GetComponent<_UI_Control>()._UI_Little[1].SetActive(true);
            elapsedTime += Time.deltaTime;
            //----------------------------------------------
            yield return new WaitForEndOfFrame();

            _UI_Control.Instance.GetComponent<_UI_Control>()._UI_Little[1].SetActive(false);
        }
    }
    IEnumerator _success2()
    {
        ...
        {
            //----------------------------------------------
            _UI_Control.Instance.GetComponent<_UI_Control>()._UI_Little[2].SetActive(true);
            elapsedTime += Time.deltaTime;
            //----------------------------------------------
            yield return new WaitForEndOfFrame();

            _UI_Control.Instance.GetComponent<_UI_Control>()._UI_Little[2].SetActive(false);
    ...
    IEnumerator _fail2()
    {
        ...
        {
            //----------------------------------------------
            _UI_Control.Instance.GetComponent<_UI_Control>()._UI_Little[3].SetActive(true);
            elapsedTime += Time.deltaTime;
            //----------------------------------------------
            yield return new WaitForEndOfFrame();

            _UI_Control.Instance.GetComponent<_UI_Control>()._UI_Little[3].SetActive(false);
    ...
    IEnumerator _sorrymuch()
    {
        ...
        {
            //----------------------------------------------
            _UI_Control.Instance.GetComponent<_UI_Control>()._UI_Little[4].SetActive(true);
            elapsedTime += Time.deltaTime;
            //----------------------------------------------
            yield return new WaitForEndOfFrame();

            _UI_Control.Instance.GetComponent<_UI_Control>()._UI_Little[4].SetActive(false);
