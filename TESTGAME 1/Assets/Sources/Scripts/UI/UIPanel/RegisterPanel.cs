...
public class RegisterPanel : BaseUIForm
{
    ...
    private void Awake()
    {
		ReceiveMessage(ProConst.REGISTER_MESSAGE, OnRegisterResponse);
    }
    void Start ()
	{
