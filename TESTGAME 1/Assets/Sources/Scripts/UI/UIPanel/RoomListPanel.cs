...
public class RoomListPanel : BaseUIForm
{
    ...
    private void Awake()
    {
		ReceiveMessage(ProConst.GETROOMLIST_MESSAGE, OnGetRoomListResponse);
    }
    void Start ()
	{
	...
	{
		NetConn.Instance.Send (ProConst.CREATEROOM_MESSAGE, new MessageData(PatternCode.Multiple.ToString()) );
	}
	/// <summary>
	/// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	/// </summary>
	...
	string _data = "";
	public void OnGetRoomListResponse(KeyValuesUpdate data)
	{
		MessageData messageData= data.Values as MessageData;
